...
def update_user_details():
    ...
    if username is not None: change_username(current_user, username)
    if email_address is not None: change_email_address(current_user, email_address)
    if handle is not None: change_handle(current_user, handle)
